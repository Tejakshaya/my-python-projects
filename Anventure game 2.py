...
#Do not Copy
#Things to do-
#Still working and not done yet.
#need to change some places 
#need to change the prices a bit
...
player_items = ["trusty dagger",
                "Glittering steel armour",
                "Health Portion"
                "Durandal,a mighty sword"
                "Steel Helmet "
                "Fire element"]
...
def village():
    ...
    # condition to deal with unrecognized input
        ...
        print_pause("The place you are looking for does not exist "
                    "in this village please try again.")
        village()
...
def shop():
    ...
    # if player gives an unrecognized input
        ...
        print_pause("SHOPKEEPER: I don't understand, "
                    "Specify the name of the item correctly and clearly")
        shop()
    ...
    if "gladiator" in contest_night_choice:
        ...
        if "yes" in fight_choice:
            ...
            if gold < 0:
                ...
                village()
            # if player has enough gold, the game continues.
            print_pause("\n The battle begins ..... \n")
            fight_result = fight_sequence("gladiator", 20, 50, 20)
            # if player wins the fight
            if fight_result == "player wins":
                ...
                # if player has won the special night prize already
                    ...
                    print_pause("HOST: Congratulation, stranger! you won "
                                "this battle. I gotta say I am pretty impressed of you.")
...
# A sequence to the funtion 'game_night_contest'
    ...
    for turn in range(40):
        ...
        # if player loses the battle
            ...
            if enemy == "warrior" or enemy == "gladiator":
                print_pause("NOTE: Your health restored to 30")
...
def forest_choice():
    ...
    # if player chooses to collect grapes irrespective of time
        ...
        # if player does not possess grapes in his items
            ...
            print_pause("You gather yhe grapes and pack them very carefully.")
            grapes_day_count = 0
    ...
    # condition to deal unrecognized input
        ...
        print_pause("Enter a valid number to proceed")
        forest_choice()
...
def princess_quest():
    ...
    # if player wants to gift grapes and have them in his possession
        ...
        princess_quest()
    # if player wants to gift jewellery and have them in his possession
    elif "jewellery" in princess_choice and "jewellery" in gift_items:
        print_pause("PRINCESS: Splendid jewellery !!")
        print_pause("PRINCESS: Perhaps I will wear it for our next meeting")
        player_items = remove_item(player_items, "jewellery")
        gift_items = remove_item(gift_items, "jewellery")
        print_pause("NOTE: 'jewellery' has been removed from your"
                    " possession\n")
        # if princess do not have them in her possession
        # she consider them as a gift item
        if "jewellery" not in princess_items:
            princess_items.append("jewellery")
            print_pause("NOTE: You relationship strengthened")
        princess_quest()
...
def witch():
    ...
    if "open" in witch_choice:
        ...
        if witch_room_count == 1:
            print_pause("\nYou enter the old room while on guard.")
...
def credits():
    ...
    print_pause("\n\n")
    print_pause("Thanks for playing the game, wait of the next sequel....// and this game was made by Teja.")
    exit()
